...
select e1.emp_name,e2.emp_name,e1.role from stores.employees e1 join stores.employees e2 on e1.store_id=e2.store_id and e1.emp_name <> e2.emp_name
...
--     They want to spot potential pay band patterns.
 -- "SAME" ani ostey within table ani i.e., self join and column dani pakkana a column untey adey like same city antey join based on city ani ; same salary antey join based on salary ani 
